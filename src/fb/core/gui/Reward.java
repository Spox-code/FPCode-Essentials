...
public class Reward {
    ...
    private static ItemStack getitem(String reward){
        if(reward.equals("vip")){
            ...
            item.setItemMeta(meta);
            return item;
        }else if(reward.equals("mvip")){
            ItemStack item = new ItemStack(Material.DIAMOND);
            ItemMeta meta = item.getItemMeta();

            meta.setDisplayName(HexAPI.hex("#0096fc§lNAGRODA §5§lM§6§lVIP"));
            ...
            lore.add(HexAPI.hex("  §8--===[ #0096fcFPCode.PL §8]===--"));
            lore.add("");
            lore.add(HexAPI.hex(" §7Gratulacje z zakupu rangi §dMVIP§7!"));
            lore.add(HexAPI.hex(" §7Ten token symbolizuje Twoje wsparcie"));
            lore.add(HexAPI.hex(" §7i dostęp do ekskluzywnych przywilejów."));
            lore.add("");
            lore.add(HexAPI.hex(" #0096fc★ §7Twoja Ranga: §dMVIP"));
            lore.add("");
            lore.add(HexAPI.hex("§aKliknij LPM aby odebrac"));
            lore.add("");
            lore.add(HexAPI.hex(" §8# Pamiątka z FPCode.PL - Nieprzemienny #"));
            ...
            item.setItemMeta(meta);
            return item;
        }else if(reward.equals("elita")){
            ItemStack item = new ItemStack(Material.DIAMOND_BLOCK);
            ItemMeta meta = item.getItemMeta();

            meta.setDisplayName(HexAPI.hex("#0096fc§lNAGRODA §bElita"));
            ...
            lore.add(HexAPI.hex("  §8--===[ #0096fcFPCode.PL §8]===--"));
            lore.add("");
            lore.add(HexAPI.hex(" §7Gratulacje z zakupu rangi §bElita§7!"));
            lore.add(HexAPI.hex(" §7Ten token symbolizuje Twoje wsparcie"));
            lore.add(HexAPI.hex(" §7i dostęp do ekskluzywnych przywilejów."));
            lore.add("");
            lore.add(HexAPI.hex(" #0096fc★ §7Twoja Ranga: §bElita"));
            lore.add("");
            lore.add(HexAPI.hex("§aKliknij LPM aby odebrac"));
            lore.add("");
            lore.add(HexAPI.hex(" §8# Pamiątka z FPCode.PL - Nieprzemienny #"));
            ...
            item.setItemMeta(meta);
            return item;
        }else if(reward.equals("legenda")){
            ItemStack item = new ItemStack(Material.NETHERITE_INGOT);
            ItemMeta meta = item.getItemMeta();

            meta.setDisplayName(HexAPI.hex("#0096fc§lNAGRODA §6§lLegenda"));
            ...
            lore.add(HexAPI.hex("  §8--===[ #0096fcFPCode.PL §8]===--"));
            lore.add("");
            lore.add(HexAPI.hex(" §7Gratulacje z zakupu rangi §6Legenda§7!"));
            lore.add(HexAPI.hex(" §7Ten token symbolizuje Twoje wsparcie"));
            lore.add(HexAPI.hex(" §7i dostęp do ekskluzywnych przywilejów."));
            lore.add("");
            lore.add(HexAPI.hex(" #0096fc★ §7Twoja Ranga: §6§lLegenda"));
            lore.add("");
            lore.add(HexAPI.hex("§aKliknij LPM aby odebrac"));
            lore.add("");
            lore.add(HexAPI.hex(" §8# Pamiątka z FPCode.PL - Nieprzemienny #"));
